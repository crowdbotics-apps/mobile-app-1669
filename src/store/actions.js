...
export const newplugin221_get__read = new_param => ({
  type: types.NEWPLUGIN221_GET__READ,
  new_param
})

export const newplugin221_get__readSucceeded = response => ({
  type: types.NEWPLUGIN221_GET__READ_SUCCEEDED,
  response
})

export const newplugin221_get__readFailed = error => ({
  type: types.NEWPLUGIN221_GET__READ_FAILED,
  error
})
